...
## Hogyan szerezheted meg az ősi mesterségeket?

Az ősi mesterségek megszerzése egy **küldetésrendszeren** keresztül történik. Ha elérted az [Őrző](rangok.md#-őrző) rangot, keresd fel a **Régészt** a főváros alatti **feltárt ősi romoknál** — **jobb klikkel** tudsz vele beszélni.

A Régész **küldetéseket** ad neked: minden mesterséghez teljesítened kell bizonyos feltételeket, és a szükséges tárgyakat **el kell vinned a Régészhez**. A Régész felhasználja az átadott tárgyakat, tehát azok **elvesznek** — minden megszerzési lista **egyszer használatos**!
...
Minden mesterség megszerzéséhez teljesítened kell egy **küldetést** a Régésztől. A szükséges tárgyakat vidd el hozzá — azokat felhasználja, tehát **elvesznek**. A cím megszerzése után egy **emoji** jelenik meg a neved mellett a chatben, jelezve a tudásodat.

### ⛏️ Ősi Bányász

**Küldetés:** Vidd el a Régésznek az összes Overworld ércet, mind a normál, mind a deepslate változatban — **Gyengéd érintés (Silk Touch)** enchanttal bányászva. A Régész felhasználja az érceket, tehát **elvesznek**!
...
**Küldetés:** Vidd el a Régésznek az összes, túlélő módban megszerezhető mob fejet (mob head). A Régész felhasználja a fejeket, tehát **elvesznek**!
...
**Küldetés:** Vidd el a Régésznek az összes **armor trimet** (páncéldíszítés). A Régész felhasználja a trimeket, tehát **elvesznek**!
...
**Küldetés:** Öld meg az **Ender Sárkányt**, a **Withert** és az **Elder Guardiant** is.
...
**Tutorial — Sárkány, Wither és Elder Guardian:**
A sárkányt a The End dimenzióban találod (End Portal a Strongholdban). A Witherhez 3 Wither Skeleton koponyára van szükséged (Nether Fortressben farmolhatók) és 4 soul sandre. A Withert a világ bármely pontján megidézheted, de **gondold meg, hol teszed** — hatalmas pusztítást okozhat! Az Elder Guardiant az **Ocean Monument**-ekben találod — monumentonként 3 darab spawnolja, és Mining Fatigue-ot adnak, szóval készülj fel alaposan!

---

### 🎨 Ősi Kézmíves

**Küldetés:** Vidd el a Régésznek az összes **pottery sherdet** (cserépdarab). A Régész felhasználja a cserépdarabokat, tehát **elvesznek**!
...
**Küldetés:** A **legtöbbet a szerveren játszó játékos** kapja — ez egy versenyalapú cím!
...
| Mesterség | Emoji | Küldetés | Hatás területe |
|---|:---:|---|---|
| Ősi Bányász | ⛏️ | Összes Overworld érc a Régésznek (Silk Touch) | Eszköz enchantok |
| Ősi Harcos | ⚔️ | Összes mob fej a Régésznek | Fegyver enchantok |
| Ősi Kovács | 🛡️ | Összes armor trim a Régésznek | Páncél enchantok |
| Ősi Vadász | 🏹 | Sárkány + Wither + Elder Guardian megölése | Elytra-páncél fúzió, Infinity+Mending |
| Ősi Kézmíves | 🎨 | Összes pottery sherd a Régésznek | Tárgy név/leírás testreszabása |
