...
┌──────┬──────┬──────┐
│  Di  │  Kő  │  Di  │     Di = Diorit
├──────┼──────┼──────┤     Kő = Csiszolt Kő (Smooth stone)
│  Kő  │  Ar  │  Kő  │     Ar = Arany blokk
├──────┼──────┼──────┤
│  Di  │  Kő  │  Di  │
└──────┴──────┴──────┘
```
...
```
┌──────┬──────┬──────┐
│  Mo  │  Va  │  Mo  │     Mo = Moha blokk
├──────┼──────┼──────┤     Va = Vas blokk
│  VA  │  Sm  │  Va  │     Sm = Smaragd blokk
├──────┼──────┼──────┤
│  Mo  │  Va  │  Mo  │
└──────┴──────┴──────┘
```
...
```
┌──────┬──────┬──────┐
│  La  │  Fe  │  La  │     Fe = Feketekő (Blackstone)
├──────┼──────┼──────┤     La = Lazurit blokk
│  Fe  │  Gy  │  Fe  │     Gy = Gyémánt blokk
├──────┼──────┼──────┤
│  La  │  Fe  │  La  │
└──────┴──────┴──────┘
```
...
```
┌──────┬──────┬──────┐
│  Am  │  Ob  │  Am  │     Am = Ametiszt blokk
├──────┼──────┼──────┤     Ob = Obszidián
│  Ob  │  Ne  │  Ob  │     Ne = Netherite blokk
├──────┼──────┼──────┤
│  Am  │  Ob  │  Am  │
└──────┴──────┴──────┘
```
